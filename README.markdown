...
This directory contains source files for the Russian language morphology
and dictionary. The data and implementation are licenced under the GNU
GPL3 licence, also detailed in the LICENCE file of this directory. The
...
The Russian language sources can be acquired using [giella SVN
